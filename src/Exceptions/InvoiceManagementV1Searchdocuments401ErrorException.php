...
class InvoiceManagementV1Searchdocuments401ErrorException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the InvoiceManagementV1Searchdocuments401ErrorException object to a human-readable string
     * representation.
     *
     * @return string The string representation of the InvoiceManagementV1Searchdocuments401ErrorException object.
     */
