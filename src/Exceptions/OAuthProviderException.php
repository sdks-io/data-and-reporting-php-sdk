...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \ShellDataReportingAPIsLib\Http\HttpRequest $request
     * @param \ShellDataReportingAPIsLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \ShellDataReportingAPIsLib\Http\HttpRequest $request,
        \ShellDataReportingAPIsLib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \ShellDataReportingAPIsLib\Models\OAuthProviderErrorEnum::checkValue
     */
