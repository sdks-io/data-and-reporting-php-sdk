...
class TransactionDataV1Cardusagesummary401ErrorException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the TransactionDataV1Cardusagesummary401ErrorException object to a human-readable string
     * representation.
     *
     * @return string The string representation of the TransactionDataV1Cardusagesummary401ErrorException object.
     */
