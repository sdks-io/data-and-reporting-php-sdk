...
class TransactionFeesRes implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the TransactionFeesRes object to a human-readable string representation.
     *
     * @return string The string representation of the TransactionFeesRes object.
     */
