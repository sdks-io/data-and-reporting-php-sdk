...
class CardGroupResponse implements \JsonSerializable
{
     ...
     * @maps CardGroups
     *
     * @param CardGroupResponseCardGroupsItems[]|null $cardGroups
     */
    public function setCardGroups(?array $cardGroups): void
    {
    ...
    {
        $json = [];
        if (isset($this->cardGroups)) {
            $json['CardGroups']  = $this->cardGroups;
        }
