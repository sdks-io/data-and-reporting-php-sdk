...
class PricedTransSummaryResp implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * @maps Data
     *
     * @param PricedTransSummaryResponseTransactionsSummaryItems[]|null $data
     */
    ...
    /**
     * Converts the PricedTransSummaryResp object to a human-readable string representation.
     *
     * @return string The string representation of the PricedTransSummaryResp object.
     */
