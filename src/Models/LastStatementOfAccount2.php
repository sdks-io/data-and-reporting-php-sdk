...
class LastStatementOfAccount2 implements \JsonSerializable
{
    ...
    /**
     * Converts the LastStatementOfAccount2 object to a human-readable string representation.
     *
     * @return string The string representation of the LastStatementOfAccount2 object.
     */
