...
/**
 * Builder for model PricedTransactionRes
 *
 * @see PricedTransactionRes
 */
class PricedTransactionResBuilder
{
    /**
     * @var PricedTransactionRes
     */
    private $instance;

    private function __construct(PricedTransactionRes $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Priced Transaction Res Builder object.
     */
    public static function init(): self
    {
        return new self(new PricedTransactionRes());
    }
     ...
     * Sets Data field.
     *
     * @param PricedTransactionResponse[]|null $value
     */
    ...
    /**
     * Initializes a new Priced Transaction Res object.
     */
    public function build(): PricedTransactionRes
    {
