...
/**
 * Builder for model AccountRes
 *
 * @see AccountRes
 */
class AccountResBuilder
{
    /**
     * @var AccountRes
     */
    ...
    private function __construct(AccountRes $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Account Res Builder object.
     */
    public static function init(): self
    {
        return new self(new AccountRes());
    }
    ...
    /**
     * Initializes a new Account Res object.
     */
    public function build(): AccountRes
    {
