...
/**
 * Builder for model PayerRes
 *
 * @see PayerRes
 */
class PayerResBuilder
{
    /**
     * @var PayerRes
     */
    ...
    private function __construct(PayerRes $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Payer Res Builder object.
     */
    public static function init(): self
    {
        return new self(new PayerRes());
    }
    ...
    /**
     * Initializes a new Payer Res object.
     */
    public function build(): PayerRes
    {
