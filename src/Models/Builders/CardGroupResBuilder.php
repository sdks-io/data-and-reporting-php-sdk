...
/**
 * Builder for model CardGroupRes
 *
 * @see CardGroupRes
 */
class CardGroupResBuilder
{
    /**
     * @var CardGroupRes
     */
    ...
    private function __construct(CardGroupRes $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Card Group Res Builder object.
     */
    public static function init(): self
    {
        return new self(new CardGroupRes());
    }
    ...
    /**
     * Initializes a new Card Group Res object.
     */
    public function build(): CardGroupRes
    {
