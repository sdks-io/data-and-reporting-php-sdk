...
namespace ShellDataReportingAPIsLib\Utils;
...
use ShellDataReportingAPIsLib\Http\HttpContext;
use ShellDataReportingAPIsLib\Http\HttpRequest;
use ShellDataReportingAPIsLib\Http\HttpResponse;
