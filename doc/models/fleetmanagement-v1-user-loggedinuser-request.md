...
|  --- | --- | --- | --- | --- | --- |
| `includePayerGroup` | `?bool` | Optional | True/False. The output will include the payer group information only when true is passed.<br><br>**Default**: `false` | getIncludePayerGroup(): ?bool | setIncludePayerGroup(?bool includePayerGroup): void |
| `includeEIDDetails` | `?bool` | Optional | True/False. The output will include the EID (Electronic Invoice data) information only when true is passed..<br><br>**Default**: `false` | getIncludeEIDDetails(): ?bool | setIncludeEIDDetails(?bool includeEIDDetails): void |
