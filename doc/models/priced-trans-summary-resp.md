...
| `data` | [`?(PricedTransSummaryResponseTransactionsSummaryItems[])`](../../doc/models/priced-trans-summary-response-transactions-summary-items.md) | Optional | - | getData(): ?array | setData(?array data): void |
