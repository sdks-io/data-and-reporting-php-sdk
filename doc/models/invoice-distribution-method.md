...
|  --- | --- | --- | --- | --- | --- |
| `isPrimary` | `?bool` | Optional | If True then this distribution method is the default distribution method.<br><br>**Default**: `true` | getIsPrimary(): ?bool | setIsPrimary(?bool isPrimary): void |
