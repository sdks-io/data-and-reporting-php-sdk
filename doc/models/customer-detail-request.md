...
| `payerNumber` | `?string` | Optional | Payer Number of the selected payer.<br>Optional if PayerId is passed else Mandatory<br>Example: DE00001067 | getPayerNumber(): ?string | setPayerNumber(?string payerNumber): void |
