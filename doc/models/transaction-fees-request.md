...
| `invoiceNumber` | `?string` | Optional | Invoice Number<br>Optional | getInvoiceNumber(): ?string | setInvoiceNumber(?string invoiceNumber): void |
| `postedDateFrom` | `?string` | Optional | Fee Item Posted Date From<br>Optional<br>Format: yyyyMMdd | getPostedDateFrom(): ?string | setPostedDateFrom(?string postedDateFrom): void |
| `postedDateTo` | `?string` | Optional | Fee Item Posted Date To<br>Optional<br>Format: yyyyMMdd | getPostedDateTo(): ?string | setPostedDateTo(?string postedDateTo): void |
